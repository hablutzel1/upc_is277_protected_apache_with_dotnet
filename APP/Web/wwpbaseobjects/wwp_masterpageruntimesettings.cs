   ...
   public class wwp_masterpageruntimesettings : GXWebComponent
   {
      ...
      protected void WB0S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablemain_Internalname, 1, 0, "px", 0, "px", "TableMainDesignerSelector", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         ...
         if ( wbEnd == 12 )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblBackstyletxt_Internalname, "Estilo de Fondo", "", "", lblBackstyletxt_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "RuntimeDesignSettingsTitle", 0, "", 1, 1, 0, 0, "HLP_WWPBaseObjects\\WWP_MasterPageRuntimeSettings.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 CellMarginTop", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFontsizetxt_Internalname, "Tamaño de Fuente", "", "", lblFontsizetxt_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "RuntimeDesignSettingsTitle", 0, "", 1, 1, 0, 0, "HLP_WWPBaseObjects\\WWP_MasterPageRuntimeSettings.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20237314225224", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wwp_masterpageruntimesettings.js", "?20237314225224", false, true);
         }
      ...
      protected void init_web_controls( )
      {
         ...
         radavBackstyle.addItem("Dark", "Oscuro", 0);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("FSCOLOR.LOAD","{handler:'E170S2',iparms:[{av:'AV8ColorItemClass',fld:'vCOLORITEMCLASS',pic:'',hsh:true},{av:'AV5WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''},{av:'AV10ColorName',fld:'vCOLORNAME',pic:''}]");
         ...
         setEventMetadata("TABLECOLORITEM.CLICK","{handler:'E150S2',iparms:[{av:'FSCOLOR_nFirstRecordOnPage'},{av:'FSCOLOR_nEOF'},{av:'edtavColorname_Visible',ctrl:'vCOLORNAME',prop:'Visible'},{av:'AV8ColorItemClass',fld:'vCOLORITEMCLASS',pic:'',hsh:true},{av:'AV5WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''},{av:'AV10ColorName',fld:'vCOLORNAME',pic:''},{av:'radavBackstyle'},{av:'AV6BackStyle',fld:'vBACKSTYLE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("TABLECOLORITEM.CLICK",",oparms:[{av:'AV5WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''}]}");
         setEventMetadata("FONTSIZESMALL.CLICK","{handler:'E110S2',iparms:[{av:'AV11FontSizeSelected',fld:'vFONTSIZESELECTED',pic:''},{av:'AV5WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''}]");
         ...
         setEventMetadata("FONTSIZEMEDIUM.CLICK","{handler:'E120S2',iparms:[{av:'AV11FontSizeSelected',fld:'vFONTSIZESELECTED',pic:''},{av:'AV5WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''}]");
         ...
         setEventMetadata("FONTSIZELARGE.CLICK","{handler:'E130S2',iparms:[{av:'AV11FontSizeSelected',fld:'vFONTSIZESELECTED',pic:''},{av:'AV5WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''}]");
         ...
         setEventMetadata("VBACKSTYLE.CONTROLVALUECHANGED","{handler:'E140S2',iparms:[{av:'radavBackstyle'},{av:'AV6BackStyle',fld:'vBACKSTYLE',pic:''}]");
