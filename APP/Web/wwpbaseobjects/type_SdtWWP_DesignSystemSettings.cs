...
namespace GeneXus.Programs.wwpbaseobjects
{
	...
	[XmlType(TypeName="WWP_DesignSystemSettings" , Namespace="UPC_ArquitecturaSistemasOP" )]
	[Serializable]
	...
	[GxUnWrappedJson()]
	[DataContract(Name=@"WWP_DesignSystemSettings", Namespace="UPC_ArquitecturaSistemasOP")]
