...
namespace GeneXus.Programs.wwpbaseobjects
{
	...
	[XmlType(TypeName="HomeSampleNameValueDataItem" , Namespace="UPC_ArquitecturaSistemasOP" )]
	[Serializable]
	...
	[DataContract(Name=@"HomeSampleNameValueDataItem", Namespace="UPC_ArquitecturaSistemasOP")]
