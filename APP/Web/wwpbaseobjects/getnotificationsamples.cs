...
namespace GeneXus.Programs.wwpbaseobjects {
   public class getnotificationsamples : GXProcedure
   {
      ...
      {
         this.Gxm2rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWWP_SDTNotificationsDataSample_WWP_SDTNotificationsDataSampleItem>( context, "WWP_SDTNotificationsDataSampleItem", "UPC_ArquitecturaSistemasOP") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWWP_SDTNotificationsDataSample_WWP_SDTNotificationsDataSampleItem> aP0_Gxm2rootcol )
      {
         ...
         objgetnotificationsamples.Gxm2rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWWP_SDTNotificationsDataSample_WWP_SDTNotificationsDataSampleItem>( context, "WWP_SDTNotificationsDataSampleItem", "UPC_ArquitecturaSistemasOP") ;
