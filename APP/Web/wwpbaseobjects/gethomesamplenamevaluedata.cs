...
namespace GeneXus.Programs.wwpbaseobjects {
   public class gethomesamplenamevaluedata : GXWebProcedure
   {
      public override void webExecute( )
      {
         ...
         initialize();
         Gxm3rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem>( context, "HomeSampleNameValueDataItem", "UPC_ArquitecturaSistemasOP") ;
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( GXSoapHTTPRequest.Method), "get") == 0 )
         {
            if ( StringUtil.StrCmp(StringUtil.Lower( GXSoapHTTPRequest.QueryString), "wsdl") == 0 )
            {
               ...
               GXSoapXMLWriter.WriteAttribute("targetNamespace", "UPC_ArquitecturaSistemasOP");
               GXSoapXMLWriter.WriteAttribute("xmlns:wsdlns", "UPC_ArquitecturaSistemasOP");
               ...
               GXSoapXMLWriter.WriteAttribute("xmlns:tns", "UPC_ArquitecturaSistemasOP");
               ...
               GXSoapXMLWriter.WriteAttribute("soapAction", "UPC_ArquitecturaSistemasOPaction/"+"wwpbaseobjects.AGETHOMESAMPLENAMEVALUEDATA.Execute");
         ...
         if ( ( StringUtil.StringSearch( currMethod+"&", "Execute&", 1) > 0 ) || ( currSoapErr != 0 ) )
         {
            ...
            GXSoapXMLWriter.WriteAttribute("xmlns", "UPC_ArquitecturaSistemasOP");
            if ( currSoapErr == 0 )
            {
               if ( Gxm3rootcol != null )
               {
                  Gxm3rootcol.writexmlcollection(GXSoapXMLWriter, "ReturnValue", "UPC_ArquitecturaSistemasOP", "HomeSampleNameValueDataItem", "UPC_ArquitecturaSistemasOP");
               }
            }
            else
            {
      ...
      {
         this.Gxm3rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem>( context, "HomeSampleNameValueDataItem", "UPC_ArquitecturaSistemasOP") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem> aP0_Gxm3rootcol )
      {
         ...
         objgethomesamplenamevaluedata.Gxm3rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem>( context, "HomeSampleNameValueDataItem", "UPC_ArquitecturaSistemasOP") ;
