...
namespace GeneXus.Programs.wwpbaseobjects {
   public class savefilteras : GXDataArea
   {
      ...
      protected void S112( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 es requerido.", "Nombre", "", "", "", "", "", "", "", ""),  "error",  edtavFiltername_Internalname,  "true",  ""));
      ...
      protected void wb_table2_5_0H2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_8_0H2( true) ;
         }
         else
         {
            wb_table3_8_0H2( false) ;
         }
         return  ;
      }

      protected void wb_table3_8_0H2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            context.WriteHtmlText( "<td>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divActiongroup_actions_Internalname, 1, 0, "px", 0, "px", "ActionGroupRightHTML", "left", "top", "", "", "div");
      ...
      protected void wb_table3_8_0H2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_8_0H2e( true) ;
         }
         else
         {
            wb_table3_8_0H2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20237314271678", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/savefilteras.js", "?20237314271678", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E120H2',iparms:[{av:'AV8FilterName',fld:'vFILTERNAME',pic:''},{av:'AV20CheckRequiredFieldsResult',fld:'vCHECKREQUIREDFIELDSRESULT',pic:''},{av:'AV15UserKey',fld:'vUSERKEY',pic:'',hsh:true},{av:'AV5GridStateKey',fld:'vGRIDSTATEKEY',pic:'',hsh:true}]");
