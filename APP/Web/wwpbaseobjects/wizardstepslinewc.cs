...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wizardstepslinewc : GXWebComponent
   {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wizardstepslinewc.js", "?20237314271087", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDWIZARDSTEPS.LOAD","{handler:'E120O2',iparms:[{av:'AV8StepNumber',fld:'vSTEPNUMBER',pic:'ZZZ9',hsh:true},{av:'AV7SelectedStepNumber',fld:'vSELECTEDSTEPNUMBER',pic:'ZZZ9',hsh:true}]");
