...
namespace GeneXus.Programs {
   public class rwdpromptmasterpage : GXMasterPage
   {
      ...
      protected void RenderHtmlCloseForm062( )
      {
         ...
         context.AddJavascriptSource("rwdpromptmasterpage.js", "?20237314271349", false, true);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?20237314271353", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("rwdpromptmasterpage.js", "?20237314271353", false, true);
         }
